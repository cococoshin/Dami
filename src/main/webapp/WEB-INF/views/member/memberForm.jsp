...
<script type="text/javascript">
    ...
    function checkValue()
    {
        if(!document.userInfo.userid.value){
         ...
         if(document.userInfo.idChk.value != "Check"){
        	alert("아이디 중복체크 해주세요");
        	return false;
        }  
...
<body>
	<div id="header">
		<a href="loginForm" target="_self"><img src="images/Dami.png" id="logo"></a> <!-- 수정필요 -->
	</div>

	<div class="wrap">
		<div class="content">
	     
	           <form method="post" action="memberForm" name="userInfo" onsubmit="return checkValue()"> <!-- 조건확인 -->
		        	<div>
					...
					<div class="check"> <!-- 중복체크 -->
		        		<input type="button" value="Check" class="id2" id="idChk"  onclick="openIdChk()">    
